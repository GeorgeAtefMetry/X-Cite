                ...
                <li className="nav-item-top dropdown country-switch">
                  ...
                  >
                    <NavDropdown.Item href="#action/3.1">
                      ...
                      >
                        <img alt="flag" src={flag1} className="flag flag-kw" />
                        &nbsp; Xcite Kuwait
                      </a>
                    </NavDropdown.Item>
                    <NavDropdown.Item href="#action/3.2">
                      <a
                        ...
                        href="https://m.xcite.com//skin/frontend/xvii/default/images/flags.png"
                      >
                        <img src={flag2} className="flag flag-sa" alt="flag " />
                        &nbsp; Xcite KSA
                      </a>
                    </NavDropdown.Item>
                  </NavDropdown>
                ...
                <ul className="nav nav-pills hd-mid-head-nav">
                  ...
                  >
                    ...
                    <div className="hd-dropdown-content pad15">
                      ...
                      {/* <button type="submit" onClick={()=> {handleLogIn()}} className="btn btn-warning my-1 w-100">
                                    Logout
                            </button> 
                                <Link to="/Login" className="hd-dropdown-item" rel="nofollow"  title="Log In"> 
            ...
            <div className="col-md-6 meganav-sub-menu cal-xs-12 col-md-9 col-lg-7 col-xl-7 pad10-l pad10-r">
              <div className="header-highlights">
                <ul>
                  ...
                  <li>
                    <a className="giftCards">Gift Cards</a>
                  </li>
                  <li>
                  ...
                  <li>
                    <a className="brandStore">Brand Stores</a>
                  </li>
                </ul>
              </div>
            </div>
