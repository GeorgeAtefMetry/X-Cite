...
// Products =======================================================
        ...
        // labtops
        const q_labtopsProds = query(proCollection, where('categoryName','==', 'labtops'));
        onSnapshot(q_labtopsProds,(snapshot)=>{
            setLaptops(snapshot.docs.map((doc)=>({...doc.data(), id:doc.id})))
                })
        // tablets
        const q_tabletsProds = query(proCollection, where('categoryName','==', 'tablets'));
            ...
            <div className='row'>
                <div className='col-md-12'>
                    <div className='content'>
                        ...
                        <div className='btns'>
                            <button type="button" className="btn btn-primary px-3 py-2">Personal Use</button>
                            <button type="button" className="btn btn-primary px-3 py-2">Education</button>
                            <button type="button" className="btn btn-primary px-3 py-2">Work</button>
                        </div>
                    </div>
                </div>
            </div>
