          ...
          <div className="row">
            {list.map((item) => (
              <SwiperSlide className="h-100" key={item.id}>
                <div
                  className="float-left h-100 bordrd border-end border-1"
                  style={{ height: "100%" }}
                >
                  <div className="px{-3">
                  ...
                  <div
                    className="card-body py-1 px-0"
                    style={{ height: "30%" }}
                  >
                    <span className="card-text px-2 name float-left col-lg-10">
                      {item.name}
                    </span>
                    <span className="card-text px-2 price float-left col-lg-10">
                      {item.discount
                        ? parseFloat(
                    ...
                    <div className="float-left col-lg-12 px-2 py-0">
                      {item.discount ? (
                        <span className="card-text oldprice float-left col-lg-4">
                          {item.price} KD
                        </span>
                      ) : (
                        <p></p>
